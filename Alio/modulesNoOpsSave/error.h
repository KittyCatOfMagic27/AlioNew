...
namespace errh{
  ...
  class FileTree{
    ...
    ErrorInfo get_ErrorInfo(unsigned int line){
      ErrorInfo errinfo;
      errinfo = __get_ErrorInfo(line, &root);
      return errinfo;
    }

    FileNode* getNodeOfLine(unsigned int line){
      FileNode* outnode;
    ...
    private: 
    ErrorInfo __get_ErrorInfo(unsigned int line, FileNode* n){
      ErrorInfo errinfo = {};
    ...
    FileNode* __getNodeOfLine(unsigned int line, FileNode* n){
